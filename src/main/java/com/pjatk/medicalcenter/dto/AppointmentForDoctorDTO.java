...
public class AppointmentForDoctorDTO {
    ...
    private List<AppointmentCheckUpDTO> appointmentCheckUps = new ArrayList<>();
    ...
    public AppointmentForDoctorDTO(Appointment appointment){
        ...
        this.appointmentCheckUps = appointment.getAppointmentCheckUps().stream().map(AppointmentCheckUpDTO::new).collect(Collectors.toList());
